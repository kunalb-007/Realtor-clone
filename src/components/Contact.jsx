        ...
        <div className="flex flex-col w-full">
          ...
          <div className="mt-3 mb-6">
            <textarea
              ...
              value={message}
              onChange={onChange}
              className="w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded trasition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600"
            ></textarea>
          </div>

          <a href={`mailto:${owner.email}?Suject=${listing.name}&body=${message}`}>
