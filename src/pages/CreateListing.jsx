...
export default function CreateListing() {
  ...
  async function onSubmit(e) {
    ...
    // check if discounted price is more than regular price
    ...
    // check if user uplaods more than 6 images
    if(images.length > 6) {
      setLoading(false);
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="mb-6">
          ...
          <input
            ...
            multiple
            required
            className="w-full px-3 py-1.5 text-gray-700 bg-white border border-gray-300 rounded transi duration-150 ease-in-out focus:bg-white focus:border-slate-600"
          />
        </div>
